...
<form class="form-horizontal" method="post">
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" name="company" class="form-control" value="<?= $query->company ?>" required>
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" name="telephone" class="form-control" value="<?= $query->telephone?>">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" name="account" class="form-control" value="<?= $query->account?>" required>
    </div>
  </div>
  <div class="form-group">
    <label for="" class="col-sm-2 control-label">密碼</label>
    <div class="col-sm-10">
      <input type="password" name="password" class="form-control" value="<?=$query->password?>" required>
    </div>
  </div>
  <div class="form-group">
